...
# NAMA OWNER
OWNER = os.environ.get("OWNER", "MH17_KUNAL")
...
FORCE_SUB_GROUP = int(os.environ.get("FORCE_SUB_GROUP", "-1001952437599"))
...
try:
    ADMINS = [int(x) for x in (os.environ.get("ADMINS", "5885920877,6091170475").split())]
except ValueError:
